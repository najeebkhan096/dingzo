        ...
        children: [
          ...
          Column(
            ...
            children: [
              Container(
                  ...
                  child: Text("The Item Has Arrived!",style: _const.raleway_SemiBold_9E772A(20 , FontWeight.w600),)),
              ...
              Container(
                  ...
                  child: Text("Please inspect the item in the next 3 days and make sure it is as described.Once confirmed the item is as described, please rate the seller to complete the order.Do not rate if the item came not as described and open a case.If the item has not been rated in the next 3 days, the order will be rated automatically and the transaction will be complete.",style: _const.raleway_SemiBold_9E772A(15 , FontWeight.w600),)),
         ...
         Divider(),
          ...
          Container(
            ...
            child: Center(child: Text("Buy Similer",style:_const.raleway_SemiBold_white(16, FontWeight.w600),)),
          ),
