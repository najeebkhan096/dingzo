...
import 'package:flutter/material.dart';
class Buyer_Rent_Pickup extends StatefulWidget {
  final String desired_order_docid;
  Buyer_Rent_Pickup(this.desired_order_docid);

  @override
  State<Buyer_Rent_Pickup> createState() => _Buyer_Rent_PickupState();
}

class _Buyer_Rent_PickupState extends State<Buyer_Rent_Pickup> {
  ...
  Widget build(BuildContext context) {
    ...
    //product detail
                ...
                Container(
                  ...
                  Container(
                   margin: EdgeInsets.only(left: width*0.05,right: width*0.05),
                    child: Text("\nPlease pick up the order at the negotiated time and address provided.\n\nBefore you pickup the item, please have the seller demonstrate the item is functional to avoid future issues that may occur."
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if(seller!=null)
                        ...
                        Container(
                            width: width*0.4,
                            child: Text(seller!.location_details!.address_txt.toString(),style: _const.raleway_535F5B(15 , FontWeight.w500),)),
...
//new
                InkWell(
                  onTap: ()async{
                    ...
                    await  database.updateOrder(status: 'in_use',orderid: desired_order !.order_id!).then((value) async{
                      await socialMediaDatabase.sendPushMessage(title: 'You have new message', body:'Buyer rated your order',
