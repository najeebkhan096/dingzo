...
import 'package:flutter/material.dart';
class Buyer_Rent_In_Use extends StatefulWidget {
  final String?  desired_order_docid;

  Buyer_Rent_In_Use(this.desired_order_docid);

  @override
  State<Buyer_Rent_In_Use> createState() => _Buyer_Rent_In_UseState();
}

class _Buyer_Rent_In_UseState extends State<Buyer_Rent_In_Use> {
          ...
          return
            ...
            ListView(
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(left: width*0.05,right: width*0.05),
                  child: Text("Enjoy using the item!\nPlease be sure to return it by "
                      "${ DateFormat('yMMMMEEEEd').format(returndate!)} at ${desired_order!.picktime!.time.toString()} am to avoid any additional charges!"
                    ,style: _const.raleway_535F5B(18, FontWeight.w600),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("I Need Other Help With The Order",style:_const.raleway_SemiBold_white(13, FontWeight.w600),)),
                  ),
                ),
                ...
                InkWell(
                  onTap: ()async{
                    ...
                    await  database.updateOrder(status: 'return',orderid: desired_order!.order_id!).then((value) async{
                      await socialMediaDatabase.sendPushMessage(title: 'You have new message', body:'Buyer has returend your item',
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Return item Early",style:_const.raleway_SemiBold_white(16, FontWeight.w600),)),
                  ),
                ),
