...
class NegotiatePickupTmeChange extends StatefulWidget {

  static const routename="NegotiatePickupTmeChange";

  @override
  State<NegotiatePickupTmeChange> createState() => _NegotiatePickupTmeChangeState();
}



class _NegotiatePickupTmeChangeState extends State<NegotiatePickupTmeChange> {
  Order?  current_order;
