...
class SellingInProgress extends StatelessWidget {
              ...
              List<QueryDocumentSnapshot?> mydocs = snapshot.data!.docs
                  ...
                  (
                      element['seller_id']==currentuser!.uid
                          &&
                          (
                              element['product_status']=='in_progress'
                                  || element['product_status']=='rating'
                                  || element['product_status']=='in_use'
                                  || element['product_status']=='return'
                          )
                  )
                                      ...
                                      onTap: (){
                                        if(newCategories[index].rent!){
                                          ...
                                          Navigator.push(context,
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      Seller_Sell_item_Detail_Page(
                                                        current_product: newCategories[index],)));
                                        }
                                      },
                                      child: Container(
                                        height: height*0.04,
