...
class NewShipped extends StatelessWidget {
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Center(child: Text("Print Label",style:_const.raleway_SemiBold_white(16, FontWeight.w600),)),
          ),
          SizedBox(height: height*0.02,),
          Container(
            height: height*0.055,
          ...
          Container(
            ...
            child: Center(child: Text("Mark as Shipped",style:_const.raleway_SemiBold_white(16, FontWeight.w600),)),
          ),
          SizedBox(height: height*0.02,),
          Container(
            height: height*0.055,
            ...
            child: Center(child: Text("cancel Order",style:_const.raleway_SemiBold_white(16, FontWeight.w600),)),
          ),
          SizedBox(height: height*0.02,),
