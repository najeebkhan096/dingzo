...
class Post_Request_Item extends StatefulWidget {
  static const routename = "Post_Request_Item";

  @override
  State<Post_Request_Item> createState() => _Post_Request_ItemState();
}

class _Post_Request_ItemState extends State<Post_Request_Item> {
  ...
  Future<void> _submit() async {
    ...
    if(selectedoption=="Tool for rent" || both_service){
     ...
     if(title!.isEmpty){
      ...
      _showErrorDialog(context, "Please Select Request Type");
    }
...
await   uploadFile().then((value) async{
  await _database.uploadProduct(
    ...
    Navigator.of(context).pushReplacementNamed(Posted_Success.routename,arguments: Product(
        both_service: both_service,
        views: 0,
        id: "",
        rent_fare: rent_fare,
  ...
  Future uploadFile() async {
    ...
    try {
      for (int i = 0; i <= 2; i++) {
        ...
        if(i==0 &&image_file1!=null){
          desiredfile=image_file1;
        }
        else if(i==1 && image_file2!=null){
          desiredfile=image_file2;
        }
        else if (i==2 && image_file3!=null){
          desiredfile=image_file3;
        }
        else {
        ...
        if(desiredfile!=null){
          ref = firebase_storage.FirebaseStorage.instance
              .ref()
              .child('${title!}/${Path.basename(desiredfile.path)}');
          await ref!.putFile(desiredfile).whenComplete(() async {
            ...
            child: Container(
                ...
                child: DropdownButton(
                  ...
                  hint: Container(
                      ...
                      child: Text("What Type of Request?",style:  _const.raleway_SemiBold_white(16, FontWeight.w600))),
                  items: optionlist
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Center(child: Text("Requesting your Item...",
