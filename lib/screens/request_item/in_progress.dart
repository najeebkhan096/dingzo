...
class Request_in_progress extends StatelessWidget {
            ...
            Column(
              children: [
                Container(
                    ...
                    child: Center(child: Text("No Request",style: _const.manrope_regular78909C(15, FontWeight.w700),))),
              ],
            ):
            Container(
              height: height*1,
                    ...
                    children: List.generate(newCategories.length, (index) =>
                        Container(
                          ...
                          child:   Row(
                            ...
                            children: [
                              newCategories[index].photos!.length==0?
                              Container(
                                width: width*0.3,
                                height: height*0.18,
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image: NetworkImage("https://static1.anpoimages.com/wordpress/wp-content/uploads/2020/02/Our-5-favorite-universal-USB-C-Power-Delivery-chargers-for-all-your-gadgets-Hero.png"))
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: (){
                                        ...
                                        Navigator.of(context).pushNamed(Edit_Request_Item.routename,arguments: newCategories[index]);
