...
class _EditItemState extends State<EditItem> {
  ...
  Future uploadFile() async {
    List<File> fileslist = [];
    if(image_file1!=null){
      fileslist.add(image_file1!);
    }
    if(image_file3!=null){
      fileslist.add(image_file3!);
    }
    if(image_file2!=null){
      fileslist.add(image_file2!);
    }
    photos = [currentproduct!.photos![0],currentproduct!.photos![1],currentproduct!.photos![2]];
