...
class DetailScreenOFF extends StatelessWidget {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: height*0.015,),
        Text("I like my charger cable but I must sell it",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.015,),
        Divider(),

        Text("Details",style: _const.poppin_dark_brown(22, FontWeight.w600),),
        SizedBox(height: height*0.015,),
        Text("Condition: Good",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.015,),
        Text("Brand : Apple",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.015,),
        Text("Category : Electronic Charger",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.025,),
        Divider(),
        ...
        SizedBox(height: height*0.015,),
        Text("Est Delivery: +6 days",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.015,),
        Text("Ships from: NJ",style: _const.poppin_dark_brown(15, FontWeight.w500)),
        SizedBox(height: height*0.015,),
        Text("Shipment Price: Free",style: _const.poppin_dark_brown(15, FontWeight.w500))
